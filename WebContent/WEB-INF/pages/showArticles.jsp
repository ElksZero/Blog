					...
					<div class="col-lg-12">
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							...
							<div
								...
								<form class="form-horizontal" action="<%=basePath %>" method="get">
									<div class="col-lg-6 form-group">
										<label class="col-lg-4 control-label">文章标题</label>
										<div class="col-lg-8">
											<label for="possible_title"></label>
												<input class="form-control" id="possible_title" name="possible_title" type="text" value="${possible_title }"/> 
											<label
									...
									<div class="col-lg-6 form-group">
										...
										<div class="col-lg-8">
											<label for="possible_author"></label><input class="form-control"
												id="possible_author" name="possible_author" type="text" value="${possible_author }"> <label
												class="control-label" style="display: none;"></label>
										</div>
									</div>
